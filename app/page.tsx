    ...
    <main id="top">
      ...
      <section className="hero" id="main-content">
        <div className="hero-copy">
          ...
          <p className="hero-lede">Professional home cleaning, vacation-rental care, and property services throughout Charleston, South Carolina.</p>
          <p className="hero-support">Clear pricing. Defined standards. Documented completion. Thoughtful service from booking through the Charleston Finish.</p>
          ...
          <div className="hero-proof" aria-label="Charleston Clean Routine experience"><p><span>01</span><strong>See the standard.</strong></p><p><span>02</span><strong>Build what fits.</strong></p><p><span>03</span><strong>Know what follows.</strong></p></div>
        </div>
      ...
      <section className="final-cta" id="book"><img className="final-cta-logo" src="/charleston-clean-routine-logo-reversed.svg" alt="Charleston Clean Routine" /><p className="eyebrow eyebrow-light">One less thing on your list</p><h2>Your home, handled.</h2><p>See what&apos;s included. Build your service. Know your price. Book when you&apos;re ready.</p><div><a className="button button-spark" href="#pricing-tool">Build My Routine</a><a className="button button-ghost" href="#your-choice">Explore Services</a></div></section>
