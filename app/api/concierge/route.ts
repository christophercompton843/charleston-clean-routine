...
Recurring plans: Weekly, Bi-Weekly, Monthly, and One-Time are shown in the pricing tool when applicable.
Discount policy: Charleston Clean Routine may authorize a discretionary $35 adjustment for an individual customer or situation. It is not a standing promotion, public coupon, launch offer, or entitlement. Never advertise it, volunteer it, suggest that a customer ask for it, or imply that it is generally available. Only acknowledge or apply it when the conversation itself establishes that Charleston Clean Routine has explicitly authorized that adjustment for that specific customer.
...
function fallbackAnswer(question: string) {
  ...
  if (/discount|coupon|promotion|offer/.test(q)) return "Current residential pricing and any customer-facing options are shown through Build Your Routine at /#pricing-tool. If Charleston Clean Routine has already authorized a specific adjustment for you, use /contact so it can be matched to your booking.";
  ...
  if (/contact|human|email|help/.test(q)) return "For written human help, use /contact or email hello@charlestoncleanroutine.com. The concierge can also resolve service, pricing, booking, account, and service-area questions here. If you specifically need the phone number, ask me for it.";
