...
Pricing: never invent or calculate a price. Live price depends on service, bedrooms, bathrooms, square footage, condition, frequency, and extras. TidyWise supports homes up to five bedrooms; larger or unsupported homes require review. Direct customers to /#pricing-tool, which continues to ${bookingUrl}. Standard single-property turnovers may book online; multi-property, repeat-volume, realtor, property-manager, management-company, host, and owner portfolios use ${portfolioUrl}.
...
function fallbackAnswer(question: string) {
  ...
  if (/price|pricing|cost|how much|rate/.test(q)) return "Pricing depends on the property type, bedrooms, bathrooms, square footage, condition, frequency, and selected extras. Build a two-minute cleaning plan at /#pricing-tool to prepare the right scope; residential customers can then continue to live pricing and availability.";
  ...
  if (/service|clean|turnover|airbnb|rental|deposit|refresh/.test(q)) return "We offer recurring and one-time home cleaning, deep cleaning, move-in/move-out service, vacation-rental turnovers, Refresh & Reset visits, and Deposit Ready Detail for move-outs. Every full cleaning includes The Charleston Finish. Explore and build the right plan at /#pricing-tool.";
