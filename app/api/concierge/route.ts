...
Home Routine Clean — Studio/1b1: $166/$157.70/$154.38/$150; 2b1: $208/$197.60/$193.44/$187.20; 2b2: $249/$236.55/$231.57/$224.10; 3b2: $332/$315.40/$308.76/$298.80; 4b2: $414/$393.30/$385.02/$373; 4b3: $455/$432.25/$423.15/$410; 5b3: $497/$472.15/$462.21/$447.30; 5b4: $559/$531.05/$519.87/$503.10.
Home Deep Clean — Studio/1b1: $314/$298.30/$298/$298; 2b1: $373/$354.35/$346.89/$336; 2b2: $414/$393.30/$385.02/$373; 3b2: $497/$472.15/$462.21/$447.30; 4b2: $621/$589.95/$577.53/$558.90; 4b3: $662/$628.90/$615.66/$596; 5b3: $749/$726/$726/$726; 5b4: $799/$781/$781/$781.
Move-In / Move-Out Clean, One-Time only — Studio/1b1: $389; 2b1: $449; 2b2: $529; 3b2: $614; 4b2: $689; 4b3: $749; 5b3: $849; 5b4: $899.
Vacation Rental Turnover — Studio/1b1: $164/$155.80/$152.52/$150; 2b1: $264/$250.80/$245.52/$237.60; 2b2: $314/$298.30/$292.02/$282.60; 3b2: $369/$350.55/$343.17/$336; 4b2: $469/$445.55/$436.17/$422.10; 4b3: $519/$493.05/$482.67/$467.10; 5b3: $619/$588.05/$575.67/$558; 5b4: $669/$635.55/$622.17/$614.
Focused visits — Refresh & Reset: $99; Guest-Ready Turndown: $75.
Add-ons — Deposit Ready Detail: $75 and Move-In/Out only; inside refrigerator: $38; inside oven: $38; baseboards: $57; interior windows: $16 per window; laundry: $38 per load; change linens for an additional bed: $20 per bed. Vacation-rental clean-linen changes and bed making are included in the turnover scope; do not add a separate linen fee.
...
Recurring offer: LAUNCH35 is only for a new residential customer's initial eligible Home Routine or Home Deep cleaning when they select Weekly, Bi-Weekly, or Monthly recurring service. The customer enters LAUNCH35 at checkout for a $35 deduction. It is not valid for One-Time service, is limited to one per household, and cannot be combined with another promotion.
...
function fallbackAnswer(question: string) {
  ...
  if (/price|pricing|cost|how much|rate/.test(q)) return "Published starting prices are $166 for a one-time Home Routine Clean, $314 for a Home Deep Clean, $389 for Move-In/Move-Out, and $164 for a Vacation Rental Turnover. Recurring Routine Clean starts at $157.70 monthly, $154.38 bi-weekly, or $150 weekly. Refresh & Reset is $99 and Guest-Ready Turndown is $75. Bedroom/bathroom layout, frequency, and add-ons determine the exact total; square footage is not a price modifier. Confirm at /#pricing-tool.";
  ...
  if (/offer|discount|coupon|launch35|\$35|thirty.?five/.test(q)) return "LAUNCH35 is only for a new residential customer's initial eligible Home Routine or Home Deep cleaning when Weekly, Bi-Weekly, or Monthly recurring service is selected. Enter LAUNCH35 at checkout for $35 off. It is not valid for One-Time service, is limited to one per household, and cannot be combined with another promotion. Start at /#pricing-tool.";
