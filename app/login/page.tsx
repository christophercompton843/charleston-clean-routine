  ...
  return (
    <CustomerPageShell eyebrow="Secure account access" title="One doorway. The right dashboard." intro="TidyWise securely routes customers, accepted providers, and authorized administrators to the tools connected to their account credentials.">
      <section className="login-grid">
        <article><span>Customer</span><h2>Manage my home.</h2><p>View booking details, update account information, and use the appointment tools enabled for your account.</p><a className="button" href={customerLogin} target="_blank" rel="noreferrer">Customer login ↗</a></article>
