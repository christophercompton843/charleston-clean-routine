  ...
  return (
    <section className="trust-section" id="reviews">
      <style>{`
        ...
        .trust-review-block, .service-story { padding: 88px max(28px, calc((100vw - 1180px) / 2)); }
        ...
        .service-story-grid figcaption { position: absolute; z-index: 2; right: 18px; bottom: 18px; left: 18px; display: flex; flex-direction: column; justify-content: flex-end; }
        .service-story-grid figcaption span { color: var(--sea-bright); font-size: 8px; line-height: 1.35; font-weight: 800; letter-spacing: .12em; text-transform: uppercase; }
        ...
        @media (max-width: 900px) {
          ...
          .service-story-heading { grid-template-columns: 1fr; gap: 18px; }
          .founder-trust { grid-template-columns: 1fr; gap: 30px; }
          .founder-trust-visual { justify-self: start; width: min(320px, 100%); }
        }
        @media (max-width: 620px) {
          .trust-review-block, .service-story { padding-block: 64px; }
          .trust-proof-grid, .service-story-grid { grid-template-columns: 1fr; }
      ...
      <div className="trust-review-block">
        <div className="section-heading split-heading trust-heading">
          <div>
            <p className="eyebrow">Charleston-owned. Personally accountable.</p>
            <h2>Standards you can see.<br />Responsibility you can reach.</h2>
          </div>
        ...
        <div className="trust-proof-grid" aria-label="How Charleston Clean Routine earns trust">
          <article><span>01</span><strong>Screened professionals</strong><p>Provider requirements are reviewed before assignment.</p></article>
          <article><span>02</span><strong>Clear before arrival</strong><p>Scope, schedule, and property instructions are organized before service begins.</p></article>
          <article><span>03</span><strong>Quality checked</strong><p>Every full cleaning ends with a final Closeout &amp; Audit.</p></article>
          <article><span>04</span><strong>Local accountability</strong><p>Charleston Clean Routine remains responsible for the customer experience.</p></article>
        </div>
        <div className="review-coming-card">
          <div><span>Verified reviews</span><h3>More customer feedback will appear here as it is earned.</h3></div>
      ...
      <section className="service-story" aria-labelledby="service-story-title">
        <div className="service-story-heading">
          <div><p className="eyebrow eyebrow-light">What the service looks like</p><h2 id="service-story-title">The standard should be visible.</h2></div>
          <p>Professional arrival, the scope you selected, a final Closeout &amp; Audit, and a home that is ready when the visit is complete.</p>
        </div>
        <div className="service-story-grid">
          <figure><img src="/ccr-cleaning-professionals.jpg" alt="Charleston Clean Routine cleaning professionals arriving prepared for service" /><figcaption><span>01 · Arrival</span><strong>Prepared.</strong><small>The professional, equipment, and property information needed for the visit.</small></figcaption></figure>
          <figure><img src="/ccr-service-levels.jpg" alt="Cleaning professional completing detailed service work in a home" /><figcaption><span>02 · Service</span><strong>The selected scope, completed.</strong><small>Your service follows the standards and property instructions established before arrival.</small></figcaption></figure>
          <figure><img src="/ccr-quality-check.jpg" alt="Cleaning professional completing a final quality check" /><figcaption><span>03 · Closeout &amp; Audit</span><strong>Checked before we leave.</strong><small>Final review, checklist, documentation, property reset, and security verification.</small></figcaption></figure>
          <figure><img src="/ccr-guest-ready.jpg" alt="Clean and composed guest-ready bedroom after professional care" /><figcaption><span>04 · The Charleston Finish</span><strong>Your home, handled.</strong><small>Clean. Documented. Secured. Cared for.</small></figcaption></figure>
        </div>
      </section>
      ...
      <section className="founder-trust" aria-labelledby="founder-trust-title">
        <div className="founder-trust-copy">
          ...
          <h2 id="founder-trust-title">I built the kind of service I wanted to book.</h2>
          <p className="founder-quote">“Hiring someone to care for your home should feel clear, dependable, and personal—not like another responsibility you have to manage.”</p>
          <p>Charleston Clean Routine is built around defined standards, thoughtful systems, accountable service, and respect for the people on both sides of the door.</p>
          <div className="founder-signoff"><strong>Christopher</strong><span>Founder / Owner · Charleston, South Carolina</span></div>
        </div>
        <div className="founder-trust-visual">
          <img src="/Christopher Compton.png" alt="Christopher, founder and owner of Charleston Clean Routine" />
