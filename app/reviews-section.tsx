  ...
  return (
    <section className="trust-section" id="reviews">
      ...
      <section className="founder-trust" aria-labelledby="founder-trust-title">
        <div className="founder-trust-copy"><p className="eyebrow eyebrow-light">A note from the owner</p><h2 id="founder-trust-title">This is my home, too.</h2><p className="founder-quote">“I live here in Charleston, and I built Charleston Clean Routine around a simple idea: hiring someone to care for your home should feel clear, dependable, and personal—not like another task you have to manage.”</p><p>My name is Christopher Compton, founder of Charleston Clean Routine. I want customers to know who is behind the company, what standards we expect, and who is accountable when something needs attention. We are building this business one home, one relationship, and one earned recommendation at a time.</p><div className="founder-signoff"><strong>Christopher Compton</strong><span>Founder / Owner · Charleston, South Carolina</span></div></div>
        <div className="founder-trust-visual"><img src="/Christopher Compton.png" alt="Christopher Compton, founder and owner of Charleston Clean Routine" /><div><span>Locally owned</span><strong>Charleston, South Carolina</strong></div></div>
      </section>
